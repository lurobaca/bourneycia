...
<title>Bodegueros de Ventas - Distribuidora Bourne y Cia S.A </title>
<!-- InstanceEndEditable -->
    ...
    <!-- IMPORTANTE deberia hacerse un solo h1 para que google pueda dar una mejor ubicacion a nuestro sitio web-->
		...
		<section>
           <article>
    		<div class="TitulpPagina" align="center">
    			<H1 class="titulos">INTEGRANTES DE LA BODEGA</H1>
    		</div>
    	  </article>
      ...
      <article>
        ...
        <Div class="Cajas">
          ...
          <div id="TextImagen">
              <img class="ImgTitular" src="img/Personal/Bodega/Bodega.jpg" width="930" height="400" alt="Bodegueros">    
              <h3 class="titulos" style="border-bottom:thin solid #F60;">Bodega</h3>
              <p class="Textos">
                En Bourne garantizamos que cada uno de los pedidos solicitados por nuestros clientes sea alistado y chequeados, de esta manera garantizamos que cada cliente recibirá cada línea solicitada de nuestro inventario disponible. Esto lo logramos hacer gracias al esfuerzo de cada día dado por  nuestros compañeros en el área de bodega.  <br/>
