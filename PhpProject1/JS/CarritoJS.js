...
function CuentaArticulosCarrito(CardCode)
{
	...
	$.ajax({
			...
			success: function(datos){
				...
				if (NumArtiCar > 0)
					{
						$("#CarBtn").html("<div  align='center'><a href='Carrito.php'>VER PEDIDO</a></div><div align='center'><a href='javascript:CrearPedido(\""+CardCode+"\")'>ENVIAR PEDIDO</a></div><div  align='center'><a href='javascript:EliminaCarrito(\""+CardCode+"\")'>ELIMINAR PEDIDO</a></div><div  align='center'><a href='Productos.php'>CONTINUAR PIDIENDO</a></div>");  
					}else {
						Palpitar =0;
						$("#CarBtn").html("<div  align='center' ><a   href='Productos.php'>HACER UN PEDIDO NUEVO</a></div>"); 
						}
...
function ActualizarArticuloCarrito(Cant_ItemCode,ItemCode,Descripcion,cantidad,Precio,Total,CardCode,Agente,ComdicionPago,Fecha,Impuesto,MontoImpuesto,Descuento,MontoDescuento,Ventana){
	...
	if (Cantidad==0 || Cantidad==null)
		 ...
		 $("#GardModifArt_"+ItemCode).css("display","none");
			...
			$("#btnAdd_"+ItemCode).html("<div class='Agregado'><input name='Cant' id='Cant_"+ItemCode+"' type='text' class='Cant' placeholder='Digite AQUI la Cantidad' style='margin-top:-30px;' onkeypress='ValidaSoloNumeros(\"Cant_"+ItemCode+"\",\""+ItemCode+"\",\""+Descripcion+"\",\""+Cantidad+"\",\""+Precio+"\",\""+Total+"\",\""+CardCode+"\",\"25\",\""+ComdicionPago+"\",\""+Fecha+"\",\""+Impuesto+"\",\""+MontoImpuesto+"\",\""+Descuento+"\",\""+MontoDescuento+"\");'value='"+Cantidad+"'/><div style='float:left;'>UNID</div><div id='AccionesAgregado'><a id='GardModifArt_"+ItemCode+"' style='float:left; display:none' href='javascript:ActualizarArticuloCarrito(\""+Cant_ItemCode+"\",\""+ItemCode+"\",\""+Descripcion+"\",\""+cantidad+"\",\""+Precio+"\",\""+Total+"\",\""+CardCode+"\",\""+Agente+"\",\""+ComdicionPago+"\",\""+Fecha+"\",\""+Impuesto+"\",\""+MontoImpuesto+"\",\""+Descuento+"\",\""+MontoDescuento+"\",\"Articulos\");'><img style='float:left;' src='img/General/Guardar.jpg' width='22' height='24' alt='Guardar'/></a><a id='ActualizaArt_"+ItemCode+"' style='float:left; ' href='javascript:Habilitaeditar(\""+ItemCode+"\",\"Habilitar\");'><img style='float:left;' src='img/General/Editar.png' width='22' height='24' alt='Modificar' /></a><a id='EliminaArt' style='float:left;'href='javascript:EliminaArticuloCarrito(\"Cant_"+ItemCode+"\",\""+ItemCode+"\",\""+Descripcion+"\",\""+Cantidad+"\",\""+Precio+"\",\""+Total+"\",\""+CardCode+"\",\"25\",\""+ComdicionPago+"\",\""+Fecha+"\",\""+Impuesto+"\",\""+MontoImpuesto+"\",\""+MontoImpuesto+"\",\""+Descuento+"\",\""+MontoDescuento+"\",\"Articulos\");'><img style='float:left;' src='img/General/Borrar.png' width='22' height='24' alt='Eliminar' /></a></div></div>");
						}
