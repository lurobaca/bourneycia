...
<title>Productos - Distribuidora Bourne y Cia S.A</title>
...
/**/		
  $('#Familias').change(function(){
						...
						if(valor.length<1)
						  ...
						  ObtienePaginas(0,0,10,usuario,valor,"");
						  }
...
<!-- InstanceEndEditable -->
    ...
    <section>
      ...
      <div class="TitulpPagina" align="center">
        <H1 class="titulos" > TODOS LOS PRODUCTOS DE BOURNE & CIA</H1>
        </div>
    </article>
      <article id="Col1">
       <div Class="HeadCol">
              ...
              <div class="OF">
              <a href="Productos.php"  style="margin-left:10px;" onclick="ObtieneDatosDePagia(0,50,<?php 
			   																									  if (trim($_SESSION ['usuario']) <> "")
																												     echo trim("'".$_SESSION ['usuario']."'"); 
																												  else 
																												     echo "0"; 
																												  ?>,'of '); return false"><img src="img/General/Ofertas.gif" width="150" height="103"   title="CLICK AQUI PARA VER OFERTAS"   alt="CLICK AQUI PARA VER OFERTAS" ></a>
    ...
    <section>
      ...
      <article class="FondoArticulos"> 
         <div id="BusquedaProducto">
		   <div style=" margin-top:15px; ">
			...
			include_once("autocompletarmysql/index.php"); ?>      
          ...
          <!--fin codigo buscar-->
           ...
           <article id="DatosDePagina" ></article>
           <br />
           <div id="loading" ></div>
     ...
     <article id="Col3">
        ...
        <div class="OF" style="margin-left:10px;">
             <div class="Abreviaturas">
             

             <h2  style="text-align:center; text-align:center;font-family: 'Fjalla One', sans-serif;  font-size: 14px; font:bold; color: #FF6600; text-align: center;letter-spacing: 1">¿Como Buscar?</h2> 
             
             <P style="padding:3px;  border-radius:3px;" class="Textos"> Busque productos con una palabra clave </P>
             <P style="padding:3px;  border-radius:3px;" class="Textos" > Revise la lista al digitar la palabra clave </P>
            <P style="padding:3px; border-radius:3px;" class="Textos"> De clic encima de las imágenes para más información </P>
              
              
       <H2 style="color:#333;">Familia</H2>
      <select name="Familias" id="Familias" style="width:150PX;">
      <option value="">Todo</option>
      <?PHP
 			$resul = $objArticulos->mostrar_FAMILIAS();
			while ( $Valor = mysql_fetch_array($resul)){
		          echo "<option value='".$Valor["FAMILIA"]."'> ". $Valor["FAMILIA"]."</option>";
			    }
		?>
      ...
      <option value="">Todo</option>
      <?PHP
 			$resul = $objArticulos->mostrar_CATEGORIAS();
			while ( $Valor = mysql_fetch_array($resul)){
		          echo "<option value='".$Valor["CATEGORIA"]."'> ". $Valor["CATEGORIA"]."</option>";
			    }
		?>
      
      </select>
         <H2 style="color:#333;">Marcas</H2>
      <select name="Marcas" Id="Marcas" style="width:150PX;">
      <option value="">Todo</option>
      <?PHP
 			$resul = $objArticulos->mostrar_MARCAS();
			while ( $Valor = mysql_fetch_array($resul)){
