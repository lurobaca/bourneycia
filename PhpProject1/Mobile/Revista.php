...
<title>Revista - Distribuidora Bourne y Cia S.A</title>
<!-- InstanceEndEditable -->
</head>
<body>
...
<img src="img/General/Head_Mobil.jpg" >
  ...
  <div id="LayoutDiv1" style="margin-top:120px; padding:3px; border-radius:3px; border:thin solid #F60; ">
    <!-- InstanceBeginEditable name="EditRegion1" -->
       ...
       <div style="height:30px;  margin-top:25px; margin-bottom:5px; border-bottom:thin solid #C0C0C0; " align="center">
        <H1 class="titulos" >REVISTA</H1>
        </div>
        <div align="center">
        <a href="DescargarPDF.php?mi_pdf=revista" title="Descargar Revista" target="_parent" >
       <img src="img/Revista/Revista.jpg" width="189" height="250" >
       </a>
       </div>
        <P>
        Aquí puedes descargar La revista actual de nuestras ofertas y descuentos
        </P>
        <div class="ImgRevista">
          <img src="img/Revista/r1.gif" width="300" height="200">
          <br>
          <img src="img/Revista/r2.gif" width="300" height="200">
           <br>
          <img src="img/Revista/r3.gif" width="300" height="200">
           <br>
          <img src="img/Revista/r4.gif" width="300" height="200">
           <br>
          <img src="img/Revista/r5.gif" width="300" height="200">
           <br>
          </div> 
         <div class="PantallaCompletaRevista" align="center">
	
  	<a href="DescargarPDF.php?mi_pdf=revista" title="Descargar Revista" target="_parent" >Descargar Revista en PDF</a>
