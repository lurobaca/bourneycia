...
?>
 ...
 <title>Bienvenido - Distribuidora Bourne y Cia S.A</title>
...
-->
	...
	try{
		...
		ObtieneDatosDePagia(0,50,<?php if (isset($usuario)) echo "'".$usuario."'"; else  echo "0"; ?>,'OF ');
		
//ObtienePaginas(1,10,<?php if (isset($usuario)) echo "'".$usuario."'"; else  echo "0"; ?>,'OF ');
    ...
    <!-- IMPORTANTE deberia hacerse un solo h1 para que google pueda dar una mejor ubicacion a nuestro sitio web-->
      ...
      <?php include("Ayuda.php");  ?>
            <!-- InstanceBeginEditable name="EditRegion3" --> <!-- <aside> no tienen una posicion definica, son epara todas las cosas del sitio web sin que sean una  parte importante de la web-->
       <article>
      	 <div align="center" class="TitulpPagina">
        <H1 class="titulos"  > BIENVENIDOS A BOURNE & CIA DIGITAL</H1>
        </div>
    </article>
         <article>
         <br>
     ...
     <article id="Col1">
       <div Class="HeadCol">
            ...
            <!-- <div class="OF">
            <a href="Revista.php" style="margin-left:10px;"><img src="img/Revista/Revista.jpg" width="149" height="190" title="CLICK AQUI PARA VER LA REVISTA" alt="CLICK AQUI PARA VER LA REVISTA"></a>
            </div>-->
              ...
              <a href='#' onclick="ObtieneDatosDePagia(0,50,<?php 
              	...
              	<img src="img/General/Ofertas.gif" width="150" height="103"   title="CLICK AQUI PARA VER OFERTAS" alt="CLICK AQUI PARA VER LA OFERTAS">
              </a>

              </div>
              
              <div class="OF">
              <a href="TradeMarketing.php"  style="margin-left:10px;"> <img src="img/General/BOURNETRADEMARKETING.gif" width="149" height="111"  title="CLICK AQUI PARA VER MAS SOBRE TRADEMARKETING" alt="CLICK AQUI PARA VER MAS SOBRE TRADEMARKETING"></a>
             
              </div>
              
              <div class="OF">
              <h2  style="text-align:center; text-align:center;font-family:  sans-serif;  font-size: 16px; font:bold; color: #FF6600; text-align: center;letter-spacing: 1">Mision</h2> 
              <p class="Textos" style="font-family:  sans-serif;  font-size: 12px;">
           Somos una empresa privada, comprometida con nuestros  socios comerciales, fundamentada hacia un gran espíritu de servicio en ventas  dirigidas al sector domestico ( consumo) e industrial ( institucional),  atendiendo mayorista, minoristas y co-distribuidores  en todas nuestras áreas de distribución.</p>
             
              </div>
               <div class="OF">
               <h2  style="text-align:center; text-align:center;font-family: sans-serif;  font-size: 16px; font:bold; color: #FF6600; text-align: center;letter-spacing: 1">Vision</h2> 
                <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">
           Posicionarnos  como la mejor distribuidora por excelencia, calidad, competitividad y servicio  dentro de             todas nuestras zonas de influencia.</p>
       ...
       <div id="container" ></div>
        ...
        <div Class="HeadCol">
           <div class="OF">
             ...
             <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">Solicite su Usuario y Contraseña al agente de ventas o mediante la pestaña contáctenos o si gusta vía teléfono</p>
             <h2  style="text-align:center; text-align:center;font-family:  sans-serif;  font-size: 16px; font:bold; color: #FF6600; text-align: center;letter-spacing: 1">Algunas Ventajas</h2>
             <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">Revisión de facturas pendientes</p>
             <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">Realización de cotizaciones y pedidos</p>
             <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">Ver los productos y ofertas con imágenes</p>
             <p class="Textos"style="font-family:  sans-serif;  font-size: 12px;">Ver información detallada de productos</p>
             <p>&nbsp;</p>
