...
<title>Vision - Mision - HISTORIS - Distribuidora Bourne y Cia S.A</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
    ...
    <section>
      ...
      <div class="TitulpPagina" align="center">
        <H1 class="titulos"  >SOBRE DISTRIBUIDORA BOURNE Y CIA S.A </H1>
        </div>
    </article>
     ...
     <article>
      <div class="Cajas">
       ...
       <div id="TextImagen">
        ...
        <div class="Subtext">
          <h3 class="Subtitulos">MISION</h3>
        
           <p class="Textos">
           Somos una empresa privada, comprometida con nuestros  socios comerciales, fundamentada hacia un gran espíritu de servicio en ventas  dirigidas al sector domestico ( consumo) e industrial ( institucional),  atendiendo mayorista, minoristas y co-distribuidores  en todas nuestras áreas de distribución.
              ...
              <div class="Subimg">
              <img src="img/General/MISION.gif" alt="Mision">
           </div>
      ...
      <div class="Cajas">
       ...
       <div id="TextImagen">
        <div class="Subtext">
          <h3 class="Subtitulos">VISION</h3>
          <p class="Textos" >
             Posicionarnos  como la mejor distribuidora por excelencia, calidad, competitividad y servicio  dentro de             todas nuestras zonas de influencia
                <br>
                   <br>   <br>   <br><br>
             </p>
          </div>
          <div class="Subimg">
              <img src="img/General/VISION.gif" alt="visio" >
           </div>
      </div>
     </div>
     </article>
      ...
      <div class="Cajas">
       ...
       <div id="TextImagen">
        <div class="Subtext">
          ...
          <h3 class="Subtitulos">HISTORIA</h3>
       <p class="Textos">Bourne & Cía es una compañía especializada en la comercialización
y distribución de  productos de consumo masivo.
<br>
La compañía cuenta con una gran gama diversifica de productos líderes  en el mercado.
<br>
Bourne nació desde hace más de 15 años, de la mano del señor Vinicio fallas Montero, actualmente Gerente general de la compañía, hoy en día Bourne cuenta con una amplia experiencia en administración y manejo de personal, aunado a esto Bourne posee un gran  conocimiento de todas las zonas de influencias en el mercado
      ...
      <br>
          ...
          <div class="Subimg">
             <img src="img/General/VALORES.gif" alt="Valores">
           </div>
      </div>
     </div>
     </article>
