      ...
      <article>
        ...
        <Div class="Cajas">
          ...
          <div id="TextImagen">
              ...
              <h3 class="titulos" style="border-bottom:thin solid #F60;">Agentes</h3>
              <p class="Textos">
...
Cada semana nuestra fuerza de venta recibe capacitación con información actualizadas sobre las ventajas de nuestros productos esta información será transmitida a nuestros clientes para que estos logren mejorar sus ventas
        ...
        <h4 style="color:#F60; border-bottom:thin solid #F60;" >Supervisores Autorizados</h4>
          ...
          <h4 style="color:#F60;border-bottom:thin solid #F60;" >Agentes Autorizados</h4>
           ...
           <div class="CajaPersona">
            ...
            <div class="CajaPersona">
             <div class="Imgagente"><img src="img/General/SinFoto.gif" alt="SinFoto"></div>
             <div class="IfoAgente">
                 <p><strong>Nombre      :</strong> Julio Briseño</p> 
