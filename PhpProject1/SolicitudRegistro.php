...
if (isset($_POST['email']) != "") {
	...
	// asunto del email
	$subject = "solicitud de CLIENTE NUEVO";
	
	// Cuerpo del mensaje
	$mensaje = "---------------------------------- \n";
	$mensaje.= "            DAOTS CLIENTE NUEVO               \n";
	$mensaje.= "---------------------------------- \n";
	$mensaje.= "CEDULA CONTACTO:   ".$_POST['txtCedulaContacto']."\n";
	$mensaje.= "NOMBRE CONTACTO:   ".$_POST['txtNombreContacto']."\n";
	$mensaje.= "NOMBRE EMPRESA:  ".$_POST['txtNombreLocal']."\n";
	$mensaje.= "CATEGORIA:".$_POST['txtCategoria']."\n";
	$mensaje.= "EMAIL:    ".$_POST['email']."\n";
	$mensaje.= "TELEFONO: ".$_POST['txtTelefono']."\n";
	$mensaje.= "EMAIL: ".$_POST['txtCorreo']."\n";
	$mensaje.= "DIRECCION: ".$_POST['txtDireccion']."\n";
...
<!-- InstanceEndEditable -->
    ...
    <section>
      <article>
      <H5 class="titulos" style="height:30px; margin-top:50px; border-top:thin solid #C0C0C0; border-bottom:thin solid #C0C0C0; " align="center">SOLICITUD DE REGISTRO</H5>
	...
	<div style="padding:10px;">
     ...
     <input name="txtNombreLocal" id="txtNombreLocal" type="text" class="CajaTexto" placeholder="Nombre del local" required /><br />

    <input name="txtCategoria" id="txtCategoria" type="text" class="CajaTexto"  placeholder="Categoria del negocio (Pulperia,Mini Super , etc..)"  /><br />    
    
       
     <input name="txtCedulaContacto" id="txtCedulaContacto" type="text" class="CajaTexto" placeholder="Numero de Cedula de la persona a Contactar" required /><br />
     
    
     <input name="txtNombreContacto" id="txtNombreContacto" type="text" class="CajaTexto" placeholder="Nombre de la persona a Contactar " required /><br />
     
   <input name="txtCorreo" id="txtCorreo" type="text" class="CajaTexto"  placeholder="Correo Electronico "  /><br />  
    <input name="txtTelefono" id="txtTelefono" type="text" class="CajaTexto"  placeholder="Telefono del local o contacto"  /><br />  
  
     
  
    <input name="txtDireccion" id="txtDireccion" type="text" class="CajaTexto"  placeholder="Direccion del local"  /><br /> 
    
    
    <label for="btsend" class="Etiquetas">&nbsp;</label> <br>
    
 <button name="btsend" id="btsendRegistro" type="submit">Enviar</button>
<DIV id="OpLogin">



<div id="ComoObtenerPassword">

<p>Esta informacion sera enviada a las oficinas de BOURNE Y CIA S.A en la cual crearemos el codigo del cliente y se le asignara el agente que visite la zona .

Para mayor informacion contactenos en nuestra seccion de <a  href="Contactenos.php">CONTACTENOS ó a los telefonos : 2669-6116 ó 2669-6250</a> 
</p>
</div>
</DIV>
