...
if (isset($_POST['email']) != "") {
	// email de destino
	$email = "roberto.bastos@bourneycia.net,amartinez@bourneycia.net,ivette.bonilla@bourneycia.net,ricardo.barrios@bourneycia.net";
...
?>
   ...
   <!--SEO -->
       ...
       <title>Contactenos - Distribuidora Bourne y Cia S.A</title>
<style type="text/css">
...
-->
    ...
    <!-- IMPORTANTE deberia hacerse un solo h1 para que google pueda dar una mejor ubicacion a nuestro sitio web-->
      ...
      <?php include("Ayuda.php");  ?>
            <!-- InstanceBeginEditable name="EditRegion3" --><section>
       <article>
       ...
       <DIV id="Contactenos">
<img src="img/General/Contactenos.jpg" style="margin-left:100px;"  alt="Contactenos">
              <DIV style="padding-left:5px; position:relative;top:-250px;left:100px; margin-right:5px;">
                <p class="Textos">
                DISTRIBUIDORA BOURNE Y COMPAÑIA S.A <br><br>
                COSTA RICA<br><br>
              ...
              <DIV style="padding-left:5px; position:relative;top:-210px;left:100px; border-radius:5px; border-color:#F60;">
              
              
              <form action="#" method="post" class="formul">

<label class="Etiquetas">Nombre:</label>
     <input name="nombre" id="nombre" type="text" class="CajaTexto" placeholder="" required /><br />
<label class="Etiquetas">Empresa:</label>
    <input name="empresa" id="empresa" type="text" class="CajaTexto"  placeholder=""  /><br />

<label class="Etiquetas">Correo Electronico:</label>
    <input name="email" id="email" type="text" class="CajaTexto" placeholder="" required/><br>
    
<label class="Etiquetas">Telefono:</label>
    <input name="telefono" id="telefono" type="text" class="CajaTexto" placeholder="" required/><br>
    
<label class="Etiquetas">Mensaje:</label>
    <textarea name="mensaje" cols="30" rows="6" class="CajaTexto" placeholder="" ></textarea><br>
    ...
    <button name="btsend" id="btsendContact" type="submit">Enviar</button>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3923.5410796061374!2d-85.10459303715223!3d10.457944022210418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f9ffb2d64e5fe69%3A0xb36fd673d6c36c1b!2sBourne%26Cia.SA!5e0!3m2!1ses!2s!4v1443891738442" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
       </DIV>
