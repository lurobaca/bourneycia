...
<a href="Mobile/Facturas.php">Facturas.php</a>
...
-->
    ...
    <article>
      <div id="container">
        <div id="tabs">
        <ul>
          <li><a href="#tab-1">Informacion</a></li>
          <li><a href="#tab-2">Facturas Pendientes</a></li>
          <li><a href="#tab-3">Pedidos Hechos en WEB </a></li>
        </ul>
       <div id="tab-1">
        <?php 
        ...
        if($aviso<>"")
         ...
         <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Codigo de cliente</p>
         <p class="Textos"  ><?php echo $Info['CardCode']; ?></p>
         
        <!-- <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Monto de la D151</p>
         <p class="Textos"  ><?php  //	echo $Info['D151']; ?></p>-->
         <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Agente asignado</p>
         <p class="Textos"  ><?php  echo  $Info['SlpName']; ?></p>
         <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Dia de visita</p>
         <p class="Textos"  ><?php  echo $Info['DiaVisita']; ?></p>
      ...
      <!-- <label class="Textos">Codigo de cliente</label>
        ...
        <input name="Supervisor" id="Supervisor" type="text" class="CajaTexto" placeholder="Supervisor asignado"  readonly="readonly" value="<?php  echo $Info['DiaVisita']; ?>"/>-->
        ...
        <input name="NombrResponsable" id="NombrResponsable" type="text" class="CajaTexto" placeholder="Nombre de Responsable" value=" <?php  echo $Info['Name']; ?>"/><br>
            <label class="Textos" style="font-weight:bold;">Correo del Responsable Tributario</label>
        ...
        <label class="Textos" style="font-weight:bold;">Telefono del Responsable Tributario</label>
