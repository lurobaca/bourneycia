...
?>
   ...
   <!--SEO -->
        ...
        <meta name="description" content="PAGINA OFICIAL de la Distribuidora Bourne Y Cía. S.A. Es una Distribuidora de alimentos de consumo masivo Ubicada en Sandillal de Cañas, Guanacaste, Costa Rica. En Bourne y Compañía Distribuimos sus productos incrementamos sus ventas,Tel:(506)2669-6103,(506)2669-6250." />
    ...
    <!-- IMPORTANTE deberia hacerse un solo h1 para que google pueda dar una mejor ubicacion a nuestro sitio web-->
      ...
      <!-- <a href="#"> -->
        	...
        	<img  src="img/General/sort_desc.png" class="Fecha" width="20" height="20" alt="Ver Más">
              ...
              <a  href="../../BourneNueva/MiCuenta.php?Tap=3"> <li>HECHOS</li></a>
               <a  href="../../BourneNueva/Carrito.php"><li class="ultimo">EN CARRITO</li></a>
      ...
      <section>
       ...
       <aside>
        ...
        <?php 
               ...
               echo " 
                <div id='Carrito1'>
                  <a href='../BourneNueva/Carrito.php'>
                 
                   <div id='CarImg'>
                 	<img src='../BourneNueva/img/General/Carrito.png' width='80' height='80' title='VER MI PEDIDO' alt='VER MI PEDIDO'>
                  </div>
                  <br>
                  </a>
                   <div id='DatosCar'>
         ...
         /* echo "<div id='Carrito1'>
                 ...
                 <div id='CarBtn'>
                        ...
                        <div  align='center'>
                         <a href='../SISTEMAS ROBERTO/BourneNueva/Carrito.php'>VER PEDIDO</a>
                       </div>
                       <div align='center'>
                         <a href='javascript:CrearPedido(\"$Usuario\")'>ENVIAR</a>
                       </div>
                    
                       <div  align='center'>
                         <a href='javascript:EliminaCarrito(\"$Usuario\")'>ELIMINAR</a>
                       </div>
                      
                       <div  align='center'>
                         <a href='Productos.php' >CONTINUAR PEDIDO</a>
                       </div>
                    </div>
                </div>";*/
...
<input type="submit" name ="iniciar" value="Cambiar contraseña" id="btsendLogin"/>
        ...
        <footer>
              ...
              <p>Sitio Desarrollado por Luis Roberto Bastos Castillo ( Tel: 8880-1662 )</p>
