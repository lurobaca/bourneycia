...
<title>Empleo - Distribuidora Bourne y Cia S.A</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
    ...
    <!-- IMPORTANTE deberia hacerse un solo h1 para que google pueda dar una mejor ubicacion a nuestro sitio web-->
      ...
      <?php include("Ayuda.php");  ?>
        ...
        <H1 class="titulos" > SOLICITUD DE EMPLEO </H1>
        </div>
     </article>
     ...
     <article>
      <div class="Cajas">
       ...
       <div id="TextImagen">
        ...
        <div class="Subtext">
          <h3 class="Subtitulos">¿COMO SOLICITAR EMPLEO?</h3>
        
           <p class="Textos">
         Para ofrecer sus servicios, debe descargar el documento de solicitud de empleo el cual esta abajo de esta información.
Entre los datos que debe tener en cuenta están:
   <br>
   <br>
•	Fotocopia de Cedula
   <br>
...
•	Una Foto reciente
   <br>
•	Indicar el tipo de licencia  y vehículo propio si es que los tiene
   <br>
•	Fotocopia de titulos obtenidos
 </p>
              ...
              <img src="img/General/Empleo.jpg"   alt="Empleo">
           </div>
       ...
       <div class="PantallaCompletaRevista" align="center">
	
  	<a href="DescargarPDF.php?mi_pdf=Solicitud" title="Descargar Revista" target="_parent" >Descargar Solicitud de empleo</a>
...
<?php } ?>
		<section>
         <article>
           <div style="height:30px; margin-top:50px; margin-bottom:5px; border-top:thin solid #C0C0C0; border-bottom:thin solid #C0C0C0; ">
           <h5 class="titulos">SOLICITUD DE EMPLEO</h5>
           </div>
           
         </article>
           <article>
           <DIV style="padding-left:5px; position:relative;top:-10px;left:0px;">
           <form action="" method="post" class="formulario">
           
			    <input name="Puesto" id="Puesto" type="text" class="CajaTexto" placeholder="Puesto solicitado" required /><br />
			    <input name="Aspiraciones" id="Aspiraciones" type="text" class="CajaTexto"  placeholder="Aspiraciones Saraliares"  /><br />
                
                 <fieldset>
       			 <legend>   <h5>DATOS PERSONALES</h5> </legend>
              
			    <input name="Nombre" id="Nombre" type="text" class="CajaTexto" placeholder="Nombre Completo" required/><br>
    		    <input name="Cedula" id="Cedula" type="text" class="CajaTexto" placeholder="Cedula" required/><br>
    		    <input name="LugarNacimiento" id="LugarNacimiento" type="text" class="CajaTexto" placeholder="Lugar de Nacimiento" /><br>
                 <input name="Fecha" id="Fecha" type="text" class="CajaTexto" placeholder="Fecha de Nacimiento" /><br>
                <input name="Edad" id="Edad" type="text" class="CajaTexto" placeholder="Edad" /><br>
                 <input name="Direccion" id="Direccion" type="text" class="CajaTexto" placeholder="Direccion" /><br>
                 <input name="Nacionalidad" id="Nacionalidad" type="text" class="CajaTexto" placeholder="Nacionalidad" /><br>
                <input name="Provincia" id="Provincia" type="text" class="CajaTexto" placeholder="Provincia" /><br>
                 <input name="Canton" id="Canton" type="text" class="CajaTexto" placeholder="Canton" /><br>
                 <input name="NumCuentaBancoPopular" id="NumCuentaBancoPopular" type="text" class="CajaTexto" placeholder="# Cuenta Banco Popular" /><br>
                <fieldset>
       			 <legend> <h5>Tiene Licencia ?</h5> </legend>
       				<p>
			          <label> SI </label>            
			          <Input type = "radio"
		                 name = "LicSI"
               ...
               <input name="TipoLicencia" id="TipoLicencia" type="text" class="CajaTexto" placeholder="Tipo de Licencia" /><br>
              <fieldset>
       			 <legend> <h5>Tiene Veiculo propio (Carro ó Moto) ?</h5> </legend>
       				<p>
			          <label> SI </label>            
			          <Input type = "radio"  name = "CarroSI" id = "CarroSI"  value = "SI" checked = "checked" />

			          <label for = "sizeSmall"> NO </label>
			             <Input type = "radio" name = "CarroNO"  id = "CarroNO" value = "NO" />
             			</p>       
      		</Fieldset>
                <input name="TipoLicencia" id="TipoLicencia" type="text" class="CajaTexto" placeholder="Tipo de Licencia" /><br>
                 <fieldset>
       			 <legend><h5> Telefonos </h5></legend>
	                 <input name="TelCelular" id="TelCelular" type="text" class="CajaTexto" placeholder="Telefono Celular" /><br>
                     <input name="TelCasa" id="TelCasa" type="text" class="CajaTexto" placeholder="Telefono Casa" /><br>
                     <input name="TelOtros" id="TelOtros" type="text" class="CajaTexto" placeholder="Telefono Otros" /><br>
                 </Fieldset>
                 <fieldset>
       			 <legend> <h5>Estado Civil </h5></legend>
	                  <label for = "sizeSmall"> Soltero(a) </label>
			             <Input type = "radio" name = "Soltero"  id = "Soltero" value = "Soltero" />
                          <label for = "sizeSmall"> Casado(a) </label>
                         <Input type = "radio" name = "Casado"  id = "Casado" value = "Casado" />
                          <label for = "sizeSmall"> Union Libre </label>
                          <Input type = "radio" name = "UnionLibre"  id = "UnionLibre" value = "UnionLibre" />
                           <label for = "sizeSmall"> Divorciado(a) </label>
                          <Input type = "radio" name = "Divorciado"  id = "Divorciado" value = "Divorciado" />
                           <label for = "sizeSmall"> Viudo(a) </label>
                          <Input type = "radio" name = "Viudo"  id = "Viudo" value = "Viudo" />
                 </Fieldset>
                 <fieldset>
       			 <legend> <h5>Tiene Hijos </h5></legend>
	                  <label for = "sizeSmall"> SI </label>
			             <Input type = "radio" name = "HijoSI"  id = "HijoSI" value = "HijoSI" />
                          <label for = "sizeSmall"> NO </label>
                         <Input type = "radio" name = "HijoNO"  id = "HijoNO" value = "HijoNO" />
                           <input name="NumHijos" id="NumHijos" type="text" class="CajaTexto" placeholder="Cuantos Hijos?" /><br>
                 </Fieldset>
                 <input name="Email" id="Email" type="text" class="CajaTexto" placeholder="Correo Electronico" /><br>
                 ...
                 <fieldset>
       			  <legend>   <h5>NIVEL ACADEMICO</h5> </legend>
                     <table width="100%" class="Tabla">
                     
  <tr align="center">
    <td class="EncabezadoCol">NIVEL</td> <td class="EncabezadoCol">AÑOS</td>  <td class="EncabezadoCol">INSTITUCION</td>  <td class="EncabezadoCol">TITULOS OBTENIDOS</td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Primaria</td>
    <td><input name="PriAnos" id="PriAnos" type="text" class="CajaTexto" placeholder="" /><br></td>
    <td><input name="PriInstitucion" id="PriInstitucion" type="text" class="CajaTexto" placeholder="" /></td>
    <td><input name="PriTitulo" id="PriTitulo" type="text" class="CajaTexto" placeholder="" /></td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Secundaria</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Universitaria</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Post Grado</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Tecnico-Comercial</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="EncabezadoFil">Otros Cursos</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
                ...
                <textarea name="mensaje" cols="30" rows="6" class="CajaTexto" placeholder="Indique informacion adicional que desee agregar"></textarea><br>
    		    <label for="btsend" class="Etiquetas">&nbsp;</label> <br>
    		   <button name="btsend" id="btsendEmpleo" type="submit">Enviar</button>
</form>
