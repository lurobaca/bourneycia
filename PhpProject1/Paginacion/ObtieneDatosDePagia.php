...
/*Si se envia page es por que se desea mostrar los siguientes 10 link de paginas*/
  ...
  if ($_POST['DESCRIPCION']<>""){
	 ...
	 /* $miCadena  =  $DESCRIPCION;
      ...
      $result=$objArticulos->mostrar_Articulo($user,$DESCRIPCION,$LimiteINICIO,$LimiteFIN);
         $Restriccion = $objArticulos->ObtieneRestriccion($user);
	  ...
	  $result=$objArticulos->ConsultaDatosdePagina($user,$LimiteINICIO,$LimiteFIN);
    ...
    if($result){
		while( $Articulos = mysql_fetch_array($result) ) {
			...
			echo "
				...
				if ($user <> "" && $user <> "0" && $HayFacVencidas == "NO" ) 
					...
					$Cantidad = 0;
					 ...
					 if ($user <> ""  )   
				            echo "<div style='margin-top:-20px;'>Precio : ".number_format($Precio, 2)."</div><br>";
					...
					echo "<Div id='btnAdd_".$ItemCode."'>";
					 ...
					 echo "  <div class='Agregado'>
							<input name='Cant' id='Cant_". $ItemCode ."' type='text' class='Cant'  style='margin-top:-30px;'  placeholder='Digite AQUI la Cantidad' onkeypress='ValidaSoloNumeros(\"Cant_". $ItemCode ."\",\"". $ItemCode ."\",\"" . $ItemName ."\",\"1\",\"" .$Precio  ."\",\"" .$TotalLinea."\",\"".trim($user)."\",\"25\",\"".  $CPago ."\",\"". date("Y-m-d") ."\",\"".$Impuesto."\",\"".$MontoImpuesto."\",\"".$Descuento."\",\"".$MontoDescuento."\",\"".$ItemCode."\",\"".$codbarras."\",\"".$ItemName."\",\"".$existencia."\",\"".$lotes."\",\"".$Unidad."\",\"".$precio."\",\"".$PrchseItem."\",\"".$SellItem."\",\"".$InvntItem."\",\"".$AvgPrice."\",\"".$Price."\",\"".$frozenFor."\",\"".$SalUnitMsr."\",\"".$VATLiable."\",\"".$lote."\",\"".$U_Grupo."\",\"".$SalPackUn."\",\"".$FAMILIA."\",\"".$CATEGORIA."\",\"".$MARCA."\",\"".$CardCode."\",\"".$Disponible."\",\"".$U_Gramaje."\",\"".$DETALLE_1."\",\"".$LISTA_A_DETALLE."\",\"".$LISTA_A_SUPERMERCADO."\",\"".$LISTA_A_MAYORISTA."\",\"". $LISTA_A_2_MAYORISTA."\",\"".$PANALERA."\",\"".$SUPERMERCADOS."\",\"".$MAYORISTAS."\",\"".$HUELLAS_DORADAS."\",\"".$ALSER."\",\"".$COSTO."\",\"".$PRECIO_SUGERIDO."\",\"".$PuntosWeb."\",\"".$Ranking."\",\"".$CodCliente."\");' value='".$Cantidad."'  disabled />
								
								<div id='AccionesAgregado'>
								
								<a id='GardModifArt_". $ItemCode."' style='float:left; display:none' href='javascript:ActualizarArticuloCarrito(\"Cant_". $ItemCode ."\",\"". $ItemCode ."\",\"" . $ItemName ."\",\"1\",\"" .$Precio  ."\",\"" .$TotalLinea."\",\"".trim($user)."\",\"25\",\"".  $CPago ."\",\"". date("Y-m-d") ."\",\"".$Impuesto."\",\"".$MontoImpuesto."\",\"".$Descuento."\",\"".$MontoDescuento."\",\"Articulos\");' > 
								
		  							<img style='float:left;' src='img/General/Guardar.jpg' width='22' height='24' alt='Guardar' title='GUARDAR CAMBIOS' alt='CLICK AQUI PARA GUARDAR CAMBIOS'/>
								</a>
		 					     <a id='ActualizaArt_". $ItemCode."' style='float:left; ' href='javascript:Habilitaeditar(\"". $ItemCode ."\",\"Habilitar\");'> 
		  							<img style='float:left;' src='img/General/Editar.png' width='22' height='24' alt='Modificar' title='CLICK AQUI PARA MODIFICAR LA CANTIDAD' alt='CLICK AQUI PARA MODIFICAR LA CANTIDAD'/>
								</a>
								<a id='EliminaArt' style='float:left;' href='javascript:EliminaArticuloCarrito(\"Cant_". $ItemCode ."\",\"". $ItemCode ."\",\"" . $ItemName ."\",\"1\",\"" .$Precio  ."\",\"" .$TotalLinea."\",\"".trim($user)."\",\"25\",\"".  $CPago ."\",\"". date("Y-m-d") ."\",\"".$Impuesto."\",\"".$MontoImpuesto."\",\"".$Descuento."\",\"".$MontoDescuento."\",\"Articulos\",\"".$codbarras."\",\"".$ItemName."\",\"".$existencia."\",\"".$lotes."\",\"".$Unidad."\",\"".$precio."\",\"".$PrchseItem."\",\"".$SellItem."\",\"".$InvntItem."\",\"".$AvgPrice."\",\"".$Price."\",\"".$frozenFor."\",\"".$SalUnitMsr."\",\"".$VATLiable."\",\"".$lote."\",\"".$U_Grupo."\",\"".$SalPackUn."\",\"".$FAMILIA."\",\"".$CATEGORIA."\",\"".$MARCA."\",\"".$CardCode."\",\"".$Disponible."\",\"".$U_Gramaje."\",\"".$DETALLE_1."\",\"".$LISTA_A_DETALLE."\",\"".$LISTA_A_SUPERMERCADO."\",\"".$LISTA_A_MAYORISTA."\",\"". $LISTA_A_2_MAYORISTA."\",\"".$PANALERA."\",\"".$SUPERMERCADOS."\",\"".$MAYORISTAS."\",\"".$HUELLAS_DORADAS."\",\"".$ALSER."\",\"".$COSTO."\",\"".$PRECIO_SUGERIDO."\",\"".$PuntosWeb."\",\"".$Ranking."\",\"".$CodCliente."\");'> 
								  <img style='float:left;' src='img/General/Borrar.png' width='22' height='24' alt='Eliminar' title='CLICK AQUI PARA QUITAR DEL PEDIDO' alt='CLICK AQUI PARA QUITAR DEL PEDIDO'/>
					    		 </a>
								 </div>
					    	 </div>";
					 }
					 else{
			        	 echo "<input name='Cant' id='Cant_". $ItemCode ."' type='text' class='Cant'   placeholder='Digite AQUI la Cantidad' onkeypress='ValidaSoloNumeros(\"Cant_". $ItemCode ."\",\"". $ItemCode ."\",\"" . $ItemName ."\",\"1\",\"" .$Precio  ."\",\"" .$TotalLinea."\",\"".trim($user)."\",\"25\",\"".  $CPago ."\",\"". date("Y-m-d") ."\",\"".$Impuesto."\",\"".$MontoImpuesto."\",\"".$Descuento."\",\"".$MontoDescuento."\",\"".$ItemCode."\",\"".$codbarras."\",\"".$ItemName."\",\"".$existencia."\",\"".$lotes."\",\"".$Unidad."\",\"".$precio."\",\"".$PrchseItem."\",\"".$SellItem."\",\"".$InvntItem."\",\"".$AvgPrice."\",\"".$Price."\",\"".$frozenFor."\",\"".$SalUnitMsr."\",\"".$VATLiable."\",\"".$lote."\",\"".$U_Grupo."\",\"".$SalPackUn."\",\"".$FAMILIA."\",\"".$CATEGORIA."\",\"".$MARCA."\",\"".$CardCode."\",\"".$Disponible."\",\"".$U_Gramaje."\",\"".$DETALLE_1."\",\"".$LISTA_A_DETALLE."\",\"".$LISTA_A_SUPERMERCADO."\",\"".$LISTA_A_MAYORISTA."\",\"". $LISTA_A_2_MAYORISTA."\",\"".$PANALERA."\",\"".$SUPERMERCADOS."\",\"".$MAYORISTAS."\",\"".$HUELLAS_DORADAS."\",\"".$ALSER."\",\"".$COSTO."\",\"".$PRECIO_SUGERIDO."\",\"".$PuntosWeb."\",\"".$Ranking."\",\"".$CodCliente."\");' />";
					 	 echo "
								<a href='javascript:AgregarAlCarrito(\"". $ItemCode ."\",\"" . $ItemName ."\",\"1\",\"" .$Precio  ."\",\"" .$TotalLinea."\",\"".trim($user)."\",\"25\",\"".  $CPago ."\",\"". date("Y-m-d") ."\",\"".$Impuesto."\",\"".$MontoImpuesto."\",\"".$Descuento."\",\"".$MontoDescuento."\",\"".$ItemCode."\",\"".$codbarras."\",\"".$ItemName."\",\"".$existencia."\",\"".$lotes."\",\"".$Unidad."\",\"".$precio."\",\"".$PrchseItem."\",\"".$SellItem."\",\"".$InvntItem."\",\"".$AvgPrice."\",\"".$Price."\",\"".$frozenFor."\",\"".$SalUnitMsr."\",\"".$VATLiable."\",\"".$lote."\",\"".$U_Grupo."\",\"".$SalPackUn."\",\"".$FAMILIA."\",\"".$CATEGORIA."\",\"".$MARCA."\",\"".$CardCode."\",\"".$Disponible."\",\"".$U_Gramaje."\",\"".$DETALLE_1."\",\"".$LISTA_A_DETALLE."\",\"".$LISTA_A_SUPERMERCADO."\",\"".$LISTA_A_MAYORISTA."\",\"". $LISTA_A_2_MAYORISTA."\",\"".$PANALERA."\",\"".$SUPERMERCADOS."\",\"".$MAYORISTAS."\",\"".$HUELLAS_DORADAS."\",\"".$ALSER."\",\"".$COSTO."\",\"".$PRECIO_SUGERIDO."\",\"".$PuntosWeb."\",\"".$Ranking."\",\"".$CodCliente."\");'> 
		  ...
		  echo "<DIV style='padding:5PX; border-radius:5PX; margin:5PX; border:thin #F60; font-family:Georgia, 'Times New Roman', Times, serif 16px;font:bold;'>
