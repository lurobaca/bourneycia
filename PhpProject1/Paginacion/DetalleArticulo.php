...
?>
 ...
 <section>
   <article  >
      <div id="overDetalle" class="overbox" style="display: none;height:auto; background:#FFF; ">

         <div id="DetalleContenedor" style="background:#FFF; padding:15px; border-radius:5px;">
         
           <a href="javascript:hideLightboxDetalle();" style="text-decoration:none; ">
          
          <div align="right" id="CerrarVent" >
          <img src="img/General/Cerrar.png" width="25" height="25" />
          </div>
          
          </a>
              <div align="center" >
          <!--  <br />
             <div style="color:#FFF; font-size:18px; margin-top:-15px;"><?php echo $_POST['ItemName']; ?></div>
             <br />
              <br />-->
               <div style='background-color:#FF6702;box-shadow: 5px 5px 15px #333333;height:40px; padding:5px; border-radius:5px;color:#FFFFFF;
 text-decoration:none; font-family:sans-serif; font-weight:bold; font-size:30px; border-bottom:thin solid #CCCCCC;' align='center'>
				<H1>INFORMACION DETALLADA DEL ARTICULO</H1>
				</DIV>
              </div>
            ...
            <?php 
			 if (file_exists("../img/Articulos/".trim($_POST['ItemCode']).".jpg")) {
   						 echo" <img class='DetImg' src='img/Articulos/".$_POST['ItemCode'].".jpg'  width='330' height='247'>";
					} else {
   					
					echo"<img class='DetImg' src='img/General/SinImagenDisponible.jpg'  width='330' height='247'>";
						}
             ...
             <br> 
             <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Codigo Bourne</p>
             <p class="Textos" ><?php echo $_POST['ItemCode']; ?></p>
             <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;" >Descripcion</p>
             <p class="Textos" ><?php echo $_POST['ItemName']; ?></p>
            
             
              <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;">Existencias</p>
             <p class="Textos" ><?php
				if ($_POST['user'] <> ""   && $_POST['user'] <> "0" && $_POST['HayFacVencidas']  == "NO" ) {
             ...
             <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;">Precio</p>
             <p class="Textos" ><?php
									 if ($_POST['user'] <> "" && $_POST['user'] <> "0" && $_POST['HayFacVencidas']  == "NO" )  
									 	{
             ...
             <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;">Gramaje</p>
             <p class="Textos" ><?php echo $_POST['U_Gramaje']; ?></p>
             <p class="Textos" style="border-bottom:thin solid #DADADA;font-weight:bold;">Codigo de Barras</p>
             <p class="Textos" ><?php echo $_POST['codbarras']; ?></p>
           ...
           <!--   <form action="" method="post" class="formul">
               <label class="Textos">Codigo Bourne</label>
                ...
                <input name="empresa" id="empresa" type="text" class="CajaTexto"  placeholder="Direccion el negocio" value="<?php
				if ($_POST['user'] <> ""   && $_POST['user'] <> "0" && $_POST['HayFacVencidas']  == "NO" ) {
					echo number_format( $_POST['existencia'], 0) ;
					}
					else
                ...
                <input name="Estado" id="Estado" type="text" class="CajaTexto" placeholder="Estado del cliente" required value="<?php echo $_POST['codbarras'];?>" disabled="disabled"/>-->
				...
				if ($_POST['user'] <> "" && $_POST['user'] <> "0" && $HayFacVencidas == "NO" ) 
					...
					/* $valor = $objCarrito->VerificaArticuloRepetido($_POST['ItemCode'],$_POST['user']);
					 if(mysql_num_rows($valor))	{	
						 ...
						 if ($_POST['user'] <> ""  )   
				            echo "<div style='margin-top:-20px;' class='Textos'>Precio : ".$_POST['user']." , ".number_format($_POST['Precio'], 2)."</div><br>";
